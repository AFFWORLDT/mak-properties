  ...
  return (
    <div className="luxury-bg min-h-screen">
      ...
      <main className="container mx-auto px-8 py-4 md:py-12 lg:py-16 max-w-5xl">
        ...
        <hr className="border-[#dbbb90]/20 my-12 md:my-16" />
        ...
        <section className="mb-12 md:mb-16">
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20">
            ...
            <div className="space-y-8 text-gray-600">
              <div>
                ...
                <ul className="list-disc pl-6 space-y-3 text-base font-serif leading-relaxed">
                  ...
                  <li>
                    Early Mover Advantage: Through MAK Properties
            ...
            <p className="mt-8 text-gray-600 leading-relaxed text-lg font-serif" id="rent-investment">
              As MAK Properties applies a thorough due diligence process,
        ...
        <section>
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20">
            ...
            <p className="mt-8 text-gray-600 leading-relaxed text-lg font-serif">
